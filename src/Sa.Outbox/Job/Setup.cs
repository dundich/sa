...
{
    public static IServiceCollection AddDeliveryJob<TConsumer, TMessage>(this IServiceCollection services, Action<IServiceProvider, OutboxDeliverySettings>? сonfigure, int intstanceCount)
