...
public sealed partial class S3BucketClient : IS3BucketClient, IDisposable
{
    ...
    public string BuildFileUrl(string fileName) => UrlUtils.BuildFileUrl(_bucket, fileName);
