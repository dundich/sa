...
{
    public static IServiceCollection AddFileSystemFileStorage(this IServiceCollection services, FileSystemStorageOption options)
    {
        services.TryAddKeyedSingleton<FileSystemStorageOption>(options);
